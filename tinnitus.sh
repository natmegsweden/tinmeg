...
trans_conditions=( 'tinmeg1' 'restingstate' ) 			# Name(s) of condition(s) on which head position correction should be applied
...
empty_room_files=( 'emptyroom_after.fif' 'emptyroom_before.fif' )
...
downsampling_factor=5 					# must be an INTEGER greater than 1, if "downsampling = on". If "downsampling = off", this argument is ignored
