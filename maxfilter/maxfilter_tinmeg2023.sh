...
trans_conditions=( 'tinmeg3' 'rs_eo' ) 		# Name(s) of condition(s) on which head position correction should be applied
...
do
	...
	cd $data_path/$project/$subject_and_date/meg/
